...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener {
    ...
    public void onCreate() {
        mOpenVPNService = this;

        super.onCreate();
    }

    public static OpenVPNService getOpenVPNService() {
    ...
    private void showNotification(final String msg, String tickerText, boolean lowpriority, long when, ConnectionStatus status) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel("czzvpn", "PUSH_CHANNEL_NAME", NotificationManager.IMPORTANCE_HIGH);
...
//            jbNotificationExtras(lowpriority, nbuilder);
        ...
        Log.i("=-=", "=-=mNotificationManager.notify");
...
//            mProfile = ProfileManager.get(this, profileUUID);
            mProfile = (VpnProfile) intent.getSerializableExtra("vpnProfile");
    ...
    private void startOpenVPN() {
        ...
        try {
            ...
            VPNLoginStatus.logErr("Error writing config file");
            endVpnService();
            return;
        }
...
//wsj显示配置的地方
        ...
        try {
            ...
            VPNLoginStatus.logErr("未能打开 tun 模块");
    ...
    public void updateState(String state, String logmessage, int resid, ConnectionStatus level) {
        ...
        Log.i("=-=", "=-="+mNotificationAlwaysVisible+"=-="+mProcessThread);
