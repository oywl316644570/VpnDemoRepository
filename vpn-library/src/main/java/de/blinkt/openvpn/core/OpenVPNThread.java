...
import de.blinkt.openvpn.VPNLoginStatus;
...
public class OpenVPNThread implements Runnable {
    ...
    public void run() {
        try {
            ...
            VPNLoginStatus.logErr("Starting OpenVPN Thread:" + e.toString());
            ...
            try {
                ...
                VPNLoginStatus.logErr("Illegal Thread state:" + ite.getLocalizedMessage());
            } catch (InterruptedException ie) {
                VpnStatus.logError("InterruptedException: " + ie.getLocalizedMessage());
                VPNLoginStatus.logErr("IInterruptedException:" + ie.getLocalizedMessage());
            }
            if (exitvalue != 0) {
            ...
            VPNLoginStatus.logErr("No process running...");
            ...
            if (mDumpPath != null) {
                try {
                    ...
                    VPNLoginStatus.logErr(R.string.minidump_generated);
                } catch (IOException e) {
                    VpnStatus.logError("Writing minidump log: " + e.getLocalizedMessage());
                    VPNLoginStatus.logErr("Writing minidump log: " + e.getLocalizedMessage());
                }
            }
...
/*
            try {
                String[] command = {"chmod", "777", argvlist.get(0)};
                ProcessBuilder builder = new ProcessBuilder(command);
                String lbpath = genLibraryPath(command, builder);

                builder.environment().put("LD_LIBRARY_PATH", lbpath);
            ...
            VPNLoginStatus.logErr("Error reading from output of OpenVPN process:" + e.getMessage());
            stopProcess();
        }
