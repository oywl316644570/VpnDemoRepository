...
public class VpnStatus {
    ...
    public static Vector<StateListener> stateListener;
    ...
    public static StateListener mLoginStateListener;
...
//更新状态
    public static void updateStateString(String state, String msg) {
        ...
        //wsj
        VPNLoginStatus.logLoginStatus(state);
    ...
    public synchronized static void updateStateString(String state, String msg, int resid, ConnectionStatus level) {
        ...
        if(mLoginStateListener!=null){
            mLoginStateListener.updateState(state, msg, resid, level);
        }

        if(resid==R.string.state_auth_failed){
            VPNLoginStatus.logErr("failed");
        }
